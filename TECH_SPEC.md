...
- [ ] Published page works while logged out
- [ ] Unpublished page is inaccessible
...
# 37. Product improvement roadmap
...
The current MVP is considered functional when:

- [ ] A recruiter can sign up.
- [ ] A recruiter can log in.
- [ ] A recruiter can create a company.
- [ ] A recruiter can edit the company.
- [ ] A recruiter can add sections.
- [ ] A recruiter can add jobs.
- [ ] A recruiter can publish the company.
- [ ] A public visitor can access the careers page.
- [ ] A public visitor can browse jobs.
- [ ] A public visitor can search/filter jobs from `/`.
- [ ] A public visitor does not need an account.
- [ ] Recruiter data is protected by RLS.
- [ ] One recruiter cannot modify another recruiter's company.
- [ ] Logout returns to the shared homepage.
